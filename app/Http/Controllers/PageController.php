...
{
    public function index() { return view('general.submited'); }
    public function form() { return view('general.submited'); }
    ...
    public function vote($id, $name) {
        ...
        if($voter) {
            if($voter->vote_id == null) {
                ...
                return view('general.submited', compact('voter', 'candidates'));
            } else {
